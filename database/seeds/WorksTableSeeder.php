...
class WorksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('works')->insert([
            'user_id' => 7,
            'name' => '10.checkaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
            'contract_id' => 1,
            'end_date' => '2021/01/10',
            'hope_date' => '2021/04/06',
            'price_lower' => 1000,
            'price_upper' => 1000,
            'content' => '',
            'created_at' => '2020-11-22 12:44:57',
            'updated_at' => '2020-11-22 12:44:57'
        ]);
    }
